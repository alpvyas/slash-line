...
class Player(db.Model):
    ...
    bats = db.Column(db.String(10), nullable=False)
    birth_date = db.Column(db.String(10), nullable=False)
    height_feet = db.Column(db.String(10), nullable=False)
    height_inches = db.Column(db.String(10), nullable=False)
    jersey_number = db.Column(db.String(10), nullable=False)
    mlb_player_id = db.Column(db.String(10), nullable=False)
    ...
    primary_position_text = db.Column(db.String(30), nullable=False)
    primary_stat_type = db.Column(db.String(30), nullable=False)
    status = db.Column(db.String(30), nullable=False)
    team_abbrev = db.Column(db.String(10), nullable=False)
    throws = db.Column(db.String(10), nullable=False)
